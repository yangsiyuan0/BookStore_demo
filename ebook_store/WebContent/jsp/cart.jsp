	...
	<c:choose>
		...
		<div class="container">
				<div class="row" style=" height: 400px">
					<h4 style="text-align: center; margin-top:200px">您的购物车空空如也,&nbsp;<a href="${ pageContext.request.contextPath }/">前往购物<img alt="" src="${pageContext.request.contextPath}/book_img/cart.png;" width="50px"></a>...</h4>
							...
							<tbody>
								...
								<c:forEach items="${cart.map}" var="cartItem">
									...
									<td width="60" width="40%">
										...
										<img src="${ pageContext.request.contextPath }/${cartItem.value.bookBean.image}" width="70" height="60">
									</td>
									<td width="30%">
										<a target="_blank"> ${cartItem.value.bookBean.bname}</a>
									</td>
									<td width="20%">
										￥${cartItem.value.bookBean.price}
									</td>
									<td width="10%">
